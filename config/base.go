...
func (c *Config) loadInspector() {
	...
	if c.vi.Get(common.InspectorDIDAddress) != nil {
		c.inspector.didAddress = c.vi.GetString(common.InspectorDIDAddress)
	}
}
...
func (c *Config) GetInspectorDidAddress() string {
	return c.inspector.didAddress
}
