...
func TestEncodeJavaFunc(t *testing.T) {
	...
	assert.Equal(t, "1206696e766f6b651a036164641a05746f6d6b6b1a05746f6d6b6b", common.Bytes2Hex(res))
}

func TestDecodeJavaResult(t *testing.T) {
	str := "Mr.汤"
	assert.Equal(t, "Mr.汤", DecodeJavaResult(common.Bytes2Hex([]byte(str))))
}
...
func TestInvokeJavaContract(t *testing.T) {
	...
	assert.Equal(t, "1000.0", DecodeJavaResult(txReceipt.Ret))
}
