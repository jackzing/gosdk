...
var cipherSuites = []*cipherSuite{
	...
	{GMTLS_SM2_SM4_SM3, 16, 32, 16, eccSM2KA, suiteSMDH /*just for check passing, no real meaning*/, cipherSM4, macSM3, nil},
...
func macSM3(version uint16, key []byte) macFunction {
	return tls10MAC{h: hmac.New(NewSm3, key)}
}
...
const (
	...
	GMTLS_SM2_SM4_SM3                       uint16 = 0xe013
