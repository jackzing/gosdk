...
type ConnectionState struct {
	...
	PeerCertificates            []*software.Certificate   // certificate chain presented by remote peer
	VerifiedChains              [][]*software.Certificate // verified chains built from PeerCertificates
...
type ClientSessionState struct {
	...
	serverCertificates []*software.Certificate   // Certificate chain presented by the server
	verifiedChains     [][]*software.Certificate // Certificate chains we built for verification
}
...
type Config struct {
	...
	/************* Notice!!! *************/
	// if use gmtls, the length of Certificates should be two,
	// the first is sign Certificate, and second is encrypt Certificate.
	...
	VerifyPeerCertificate func(rawCerts [][]byte, verifiedChains [][]*software.Certificate) error

	// RootCAs defines the set of root certificate authorities
	// that clients use when verifying server certificates.
	// If RootCAs is nil, TLS uses the host's root CA set.
	RootCAs *software.CertPool
