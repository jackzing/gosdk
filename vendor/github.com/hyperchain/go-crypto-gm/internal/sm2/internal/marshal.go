...
import _ "unsafe" //unsafe for data convert

// 0    | 1    | 2    | 3  | 4    | 4+xl  | 5+xl | 6+xl
// 0x30 | xy+4 | 0x02 | xl | ____ | 0x02  | yl   | ____

//MarshalSig marshal
//go:linkname MarshalSig github.com/hyperchain/go-crypto-gm/internal/sm2.MarshalSig
...
//Unmarshal unmarshal
//go:linkname Unmarshal github.com/hyperchain/go-crypto-gm/internal/sm2.Unmarshal
