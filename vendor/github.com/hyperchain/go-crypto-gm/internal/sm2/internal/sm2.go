...
//Sign32bit to sign dgst
func Sign32bit(dgst []byte, reader io.Reader, key []byte) ([]byte, uint8, error) {
...
//VerifySignature32bit to verify a signature and return error
func VerifySignature32bit(sig, dgst []byte, X []byte, Y []byte) (bool, error) {
	var head int
